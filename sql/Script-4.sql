...
create table board (
  ...
  bcategory   varchar2(11),           -- 게시판 분류 코드 (code 테이블 참조)
...
insert into board (
  board_id, bcategory, title, content, writer
) values (
  board_board_id_seq.nextval, 'B0101', '테스트 제목입니다.', '이것은 테스트 내용입니다.', '테스터1'
);
...
values (board_board_id_seq.nextval, '테스트 제목', '테스트 내용', '테스터1');

insert into board (board_id, title, content, writer, created_at, updated_at)
values (board_board_id_seq.nextval, '두 번째 글', '내용입니다2', '작성자2', systimestamp, systimestamp);

insert into board (board_id, title, content, writer, created_at, updated_at)
values (board_board_id_seq.nextval, '세 번째 글', '내용입니다3', '작성자3', systimestamp, systimestamp);

insert into board (board_id, title, content, writer, created_at, updated_at)
values (board_board_id_seq.nextval, '네 번째 글', '내용입니다4', '작성자4', systimestamp, systimestamp);
